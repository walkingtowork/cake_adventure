...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { character_id: @inventory.character_id, user_id: @inventory.user_id }
    end
  ...
  test "should update inventory" do
    put :update, id: @inventory, inventory: { character_id: @inventory.character_id, user_id: @inventory.user_id }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
