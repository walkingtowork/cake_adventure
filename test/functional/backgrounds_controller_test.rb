...
class BackgroundsControllerTest < ActionController::TestCase
  ...
  test "should create background" do
    assert_difference('Background.count') do
      post :create, background: { description: @background.description, img_url: @background.img_url, name: @background.name }
    end
  ...
  test "should update background" do
    put :update, id: @background, background: { description: @background.description, img_url: @background.img_url, name: @background.name }
    assert_redirected_to background_path(assigns(:background))
  end
